...
public class ICTManager
{
    ...
    private static final ICTManager instance = new ICTManager();
    /** A list of all the recipes added */
    private List recipes = CraftingManager.getInstance().getRecipeList();

    /**
     * Returns the static instance of this class
     */
    public static final ICTManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }
